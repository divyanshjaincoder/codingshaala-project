...
const Booking = () => {
  ...
  const createOrder = async () => {
    try {
      ...
      const res = await axios.post("https://codingshaala-backend.onrender.com/api/booking/", formData);
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="javascript-live">
                          Javascript Live Course
                        </SelectItem>
                        ...
                        <SelectItem value="nodejs-backend">
